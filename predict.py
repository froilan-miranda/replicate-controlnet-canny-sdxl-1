...
class Predictor(BasePredictor):
    ...
    def predict(
        ...
        control_guidance_start: float = Input(description="The percentage of total steps at which the ControlNet starts applying", default=0.0, ge=0, le=1),
        control_guidance_end: float = Input(description="The percentage of total steps at which the ControlNet ends applying", default=1.0, ge=0, le=1)
    ) -> str:
        if controlnet_image == "":
